  ...
  _buildMapStyle(mode) {
    ...
    const style = {
      ...
      layers: [
        ...
        { id: "terrain-shade", type: "hillshade", source: "terrainSource", paint: { "hillshade-exaggeration": satellite ? 0.32 : 0.55, "hillshade-shadow-color": "#03101a", "hillshade-highlight-color": satellite ? "#9fcde4" : "#4b8da6" } },
      ],
      sky: {},
    };
    if (this._config.terrain !== false) style.terrain = { source: "terrainSource", exaggeration: 1.15 };
    return style;
  }
